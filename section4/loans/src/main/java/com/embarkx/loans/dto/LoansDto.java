...
public class LoansDto {
    ...
    @Schema(description = "Mobile Number of Customer", example = "1231231231")
    private String mobileNumber;

    @NotEmpty(message = "Loan Number can not be null or empty")
    @Pattern(regexp = "(^$|[0-9]{12})", message = "LoanNumber must be 12 digits")
    @Schema(description = "Loan Number of customer", example = "234456234567")
    ...
    @Schema(description = "Total outstanding amount against a loan", example = "990000")
